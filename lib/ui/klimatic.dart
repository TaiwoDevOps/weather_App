...
class _KlimaticState extends State<Klimatic> {
  ...
  Future<Map> getWeather(String appId, String city) async {
    String apiUrl ="http://api.apixu.com/v1/current.json?key=${util.appId}&q=$city";
            ...
            return new Container(
              ...
              child: new Column(
                ...
                children: <Widget>[
                  new ListTile(
                    title: new Text(
                      content['current']['temp_f'].toString() +" F",
                      style: new TextStyle(
                    ...
                    subtitle: new ListTile(
                       title: new Text(
                          "Humidity: ${content['location']['lat'].toString()}\n"
                              "Min: ${content['location']['lon'].toString()} F\n"
                              "Max: ${content['current']['condition']['text'].toString()} "
                              ,
                         style: extraData(),
                       ),
                    ),
